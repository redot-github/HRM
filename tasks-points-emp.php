...
<head>
        ...
        <title>Task Points - Redot Solutions</title>
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Task Points</h3>
								<ul class="breadcrumb">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped custom-table leave-employee-table mb-0 datatable">
									...
									<tbody>
										<?php
									$sql = $db->query("select * from emp_tasks where to_emp='$id' ORDER BY id DESC");
									$count = 0;
									if($sql->num_rows>0){
                                    while($row = $sql->fetch_assoc()){ ?>
										<tr>
											...
											<td><?php $a_emp_id = $row['lead_emp_code'];
