											...
											<td class="text-end">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														...
														data-task-points="<?php echo $row['task_points'];?>"
		...
		if(tea_id != "") {
			...
			$("#assign_emp").html("<option value=''>------- Select --------</option>");
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">Task points</label>
												<input type="text" class="form-control" name="task_points">
											</div>
										</div>
										<div class="col-sm-6">	
											<div class="input-block mb-3">
...
$(document).ready(function (e) {
   ...
   var data_task_to = $(this).attr('data-task-to'); 
    ...
    var data_task_points = $(this).attr('data-task-points');
    ...
    $("#task_points").val( data_task_points );
								...
								<form id="edit_tasks" method="post">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">Client</label>
												<select class="select" id="e_client" name="client" required>
													<option>Select Client</option>
													<?php  
                                     $des_sql = $db->query("select distinct client from teams_lead WHERE lead_emp_code1 ='$id' ORDER BY id ASC");
									if($des_sql->num_rows>0){
		...
		if(cli_id != "") {
			...
			$("#e_project").html("<option value=''>------- Select --------</option>");
										...
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">Project</label>
												<select class="select" id="e_project" name="project" required>
											    <option>Select Project</option>
			...
			$("#e_team_name").html("<option value=''>------- Select --------</option>");
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">Team Name</label>
												<select class="select" id="e_team_name" name="team_name" required>
											    <option>Select Team Name</option>
											    </select>
											</div>
										</div>
		...
		if(tea_id != "") {
			...
			$("#e_task_to").html("<option value=''>------- Select --------</option>");
										...
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">Assign Staff</label>
												<select class="select" id="e_task_to" name="assign_emp" required>
													<option>Select Employee</option>
												</select>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">Task Points</label>
												<input type="text" class="form-control" id="task_points" name="task_points">
											</div>
										</div>
										<div class="col-sm-6">	
											<div class="input-block mb-3">
