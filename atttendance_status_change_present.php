...
$statusMsg = '';
 ...
 //$file_attendance_status = mysqli_real_escape_string($db, $_POST["attendance_status"]);
            ...
            $update1 = $db->query("UPDATE attendance SET attendance='P' WHERE id='$file_data_id' And emp_code='$file_emp_id' And date='$file_date'");
             ...
             if($update1){		
                ...
                echo "<strong style='color:green;'>".ucwords($file_emp_id). " Attendance status Change as</strong> Present";
            }else{
