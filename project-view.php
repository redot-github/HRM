...
<head>
        ...
        <title>Project View - Redot Solutions</title>
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-end ms-auto">
								<a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#edit_project"><i class="fa-solid fa-plus"></i> Edit Project</a>
								<a href="task-board.php" class="btn btn-white float-end me-3" data-bs-toggle="tooltip" title="Task Board"><i class="fa-solid fa-bars"></i></a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
					...
					<div class="row">
										...
										<div class="col-md-3 col-sm-4 col-lg-4 col-xl-3">
											<div class="uploaded-box">
												<div class="uploaded-img">
													<img src="assets/img/placeholder.jpg" class="img-fluid" alt="Placeholder Image">
												</div>
						...
						<div class="col-lg-4 col-xl-3">
							...
							<div class="card project-user">
								<div class="card-body">
									<h6 class="card-title m-b-20">Assigned Leader <button type="button" class="float-end btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#assign_leader"><i class="fa-solid fa-plus"></i> Add</button></h6>
									<ul class="list-box">
										<li>
											<a href="profile.php">
												<div class="list-item">
													<div class="list-left">
														<span class="avatar"><img src="assets/img/profiles/avatar-11.jpg" alt="User Image"></span>
													</div>
													<div class="list-body">
										...
										<li>
											<a href="profile.php">
												<div class="list-item">
													<div class="list-left">
														<span class="avatar"><img src="assets/img/profiles/avatar-01.jpg" alt="User Image"></span>
													</div>
													<div class="list-body">
							...
							<div class="card project-user">
								<div class="card-body">
									<h6 class="card-title m-b-20">
										Assigned users 
										<button type="button" class="float-end btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#assign_user"><i class="fa-solid fa-plus"></i> Add</button>
									</h6>
									<ul class="list-box">
										<li>
											<a href="profile.php">
												<div class="list-item">
													<div class="list-left">
														<span class="avatar"><img src="assets/img/profiles/avatar-02.jpg" alt="User Image"></span>
													</div>
													<div class="list-body">
