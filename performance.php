...
<head>
        ...
        <title>Performance Review - Redot Solutions</title>
       ...
       <script src="assets/js/jquery-3.7.0.min.js"></script>
		...
		$(function () {
			...
			$(document).on("click", "#comments_remove", function () {
				$(this).closest("tr").prev().find('td:last-child').php('<button type="button" class="btn btn-danger" id="comments_remove"><i class="fa-regular fa-trash-can"></i></button>');
