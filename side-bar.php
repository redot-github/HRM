<!-- Sidebar -->
		...
		if($role_id == 2 ||  $role_id == 3){?>
									<li><a  href="dashboard.php">Employee Dashboard</a></li>
									<?php } ?>
								</ul>
							</li>
							<!--<li class="submenu">
		...
		if($role_id == 1){?>
							...
							<li> 
								<a href="announcements.php"><i class="la la-file-alt"></i> <span>Announcements</span></a>
							</li>
							<li class="submenu">
								...
								<ul>
									...
									<li><a href="leave-masters.php">Leave Masters</a></li>
									<li><a href="emp-leave-status.php">Empolyee Leave Status</a></li>
									<li><a href="leaves.php">Leaves Applied</a></li>
									<!--<li><a href="leaves-employee.php">Leaves (Employee)</a></li>
									<li><a href="leave-settings.php">Leave Settings</a></li>-->
									<li><a href="admin-attendance.php">Attendance (Admin)</a></li>
									<li><a href="attendance-reports.php">Attendance Reports(Admin)</a></li>
							...
							<li> 
								<a href="leads.php"><i class="la la-users"></i> <span>Leads</span></a>
							</li>
							<li> 
								<a href="admin-tasks-points-report.php"><i class="la la-edit"></i> <span>Task Reports</span></a>
							</li>
							<li class="submenu">
		...
		if($role_id == 2 ||  $role_id == 3){?>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a href="timesheet-employee.php">Timesheet</a></li>
									<li><a href="overtime-employee.php">Overtime</a></li>-->
								</ul>
							</li>
							<?php } ?>
							<?php 
		...
		if($role_id == 3){?>
			                <li> 
								<a href="leaves-lead-emp.php"><i class="la la-edit"></i> <span>Team Leaves</span></a>
							</li>
							<li class="submenu"> 
								<a href="#" class=""><i class="la la-users"></i> <span>Tasks</span> <span class="menu-arrow"></span></a></a>
							    <ul>
									<li><a href="tasks.php">Team Tasks</a></li>
									<li><a href="tasks-points-lead.php">Tasks Points </a></li>
								</ul>
							</li>
						<?php } ?>
		...
		if($role_id == 2){?>
			               <li class="submenu">
								<a href="#" class=""><i class="la la-user"></i> <span> Tasks</span> <span class="menu-arrow"></span></a>
								<ul>
									<li><a href="tasks-emp.php">Assign Tasks</a></li>
									<li><a href="tasks-points-emp.php">Tasks Points </a></li>
								</ul>
				           </li>
						<?php } ?>
						<?php require("hr_approve_role.php");
            if($hr_approver == 1){ ?>
				<li><a href="employees.php"><i class="la la-users"></i> <span>All Employees</span></a></li>
				<li><a href="leaves.php"><i class="la la-edit"></i> <span>Leaves Applied</span></a></li>	
				<li class="submenu">
								<a href="#"><i class="la la-money"></i> <span> Payroll </span> <span class="menu-arrow"></span></a>
								<ul>
									<li><a href="salary.php"> Employee Salary </a></li>
		...
		if($role_id == 3){?>
			                <li> 
								<a href="leaves-lead-emp.php"><i class="la la-edit"></i> <span>Team Leave Reports</span></a>
							</li>
							 <li class="submenu"> 
								<a href="#" class=""><i class="la la-users"></i> <span>Tasks</span> <span class="menu-arrow"></span></a></a>
							    <ul>
		...
		if($role_id == 2){?>
			                <li class="submenu">
								<a href="#" class=""><i class="la la-edit"></i> <span> Tasks</span> <span class="menu-arrow"></span></a>
								<ul>
									<li><a href="tasks-emp.php">Assign Tasks</a></li>
									<li><a href="tasks-points-emp.php">Tasks Points </a></li>
								</ul>
