...
<head>
        ...
        <title>Budget Revenues - Redot Solutions</title>
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-end ms-auto">
								<a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_categories"><i class="fa-solid fa-plus"></i> Add Revenues</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
