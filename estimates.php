					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-end ms-auto">
								<a href="create-estimate.php" class="btn add-btn"><i class="fa-solid fa-plus"></i> Create Estimate</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
											...
											<td class="text-end">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="edit-estimate.php"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
