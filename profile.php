...
<head>
        ...
        <title>Employee Profile - Redot Solutions</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="tab-content">
						...
						<div id="emp_profile" class="pro-overview tab-pane fade show active">
							<div class="row">
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<?php $prodcatsql2 = "SELECT * FROM manage_emp_pass WHERE emp_code = '$id'";
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<?php $prodcatsql3 = "SELECT * FROM manage_emp_emergency WHERE emp_code = '$id'";
							...
							<div class="row">
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<?php $prodcatsql4 = "SELECT * FROM manage_emp_bank WHERE emp_code = '$id'";
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<?php $prodcatsql7 = "SELECT * FROM emp_leave_status  WHERE emp_code = '$id'";
							...
							<div class="row">
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<?php $prodcatsql5 = "SELECT * FROM  manage_emp_education  WHERE emp_code = '$id'";
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<?php $prodcatsql6 = "SELECT * FROM  manage_emp_experince  WHERE emp_code = '$id'";
						...
						<!-- Bank Statutory Tab -->
						<?php $prodcatsql7 = "SELECT * FROM emp_salary WHERE emp_code = '$id'";
								$pro_results7 = mysqli_query($db, $prodcatsql7);
								$pro_data7 = $pro_results7->fetch_assoc();
								?>
